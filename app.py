...
@cross_origin()
def get_stations():
    engine = scraper.connect_db("ubuntu@ec2-18-206-204-211.compute-1.amazonaws.com:22", "3306", " dublin-bikes", "admin", "0d72d379765757bc1")
...
def hourly_avg_dynamic(station_number, day):
    ...
    for station in station_details:
        ...
        '''
        dtime [1]: This section extracts the time part from the date time string. 
        Assuming dtime is a list containing date and time information, where the element with index 1 contains the time part. 
        For example, dtime [1] may be 15:30:45 in 2024-02-25 15:30:45.
        [11:13]: This is the syntax for string slicing in Python, which means extracting substrings from a string between index positions 11 and 13 (excluding index 13).
         Here, it extracts the hour portion from the time portion. Assuming the time part is 15:30:45, then [11:13] extracts 15.
        '''
        ...
        '''
        hours'bikes [hour] [0] represents the total number of bicycles in the hour.
        hours'bikes [hour] [1] represents the number of data entries within the hour of [hour].
        '''
